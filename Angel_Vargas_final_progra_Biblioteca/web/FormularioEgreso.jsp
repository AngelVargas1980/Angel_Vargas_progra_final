...
<html>
    <head>
        ...
        <script src="js/javaScriptEgreso.js"></script>
...
<%--          
    ...
    <div class="d-flex justify-content-around">
        ...
        <h1>Formulario de Egreso de Libros</h1>
        
        <a href="EgresoController" > Click aqui </a><br><br>
        <form method="POST" id="form" name="form" action="EgresoController" >
            ...
            <div class="form-group">
              ...
              <input type="email" class="form-control" placeholder="ingresar nombre de usuario" aria-describedby="emailHelp" name="usuario" id="usuario"  >
              <small id="emailHelp" class="form-text text-muted"></small>
            </div>
            <div class="form-group">
              <label for="exampleInputPrestamo1">Fecha de prestamo</label>
              <input type="text" class="form-control"  name="prestamo" id="prestamo"  >
            </div>
            
             <div class="form-group">
              <label for="exampleInputEntrega">Fecha de entrega</label>
              <input type="text" class="form-control"  name="entrega" id="entrega"  >
            </div>
             <%--
            ...
            <button type="button" onclick="enviarFormularioEgreso()" class="btn btn-success">Guardar</button>
